...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::get('/create/new/blog', [UserDetailsController::class, 'newBlog'])->name('newblog');
    Route::post('/add/new/blog', [UserDetailsController::class, 'addBlog'])->name('addblog');
    Route::get('/deleteblog/{id}', [UserDetailsController::class, 'deleteBlog']);
    Route::get('/editblog/{id}', [UserDetailsController::class, 'editBlog']);
    Route::post('/blog/update/{id}', [UserDetailsController::class, 'updateBlog'])->name('updateblog');
